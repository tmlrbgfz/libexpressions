...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_OPERANDLIST = 9,                /* OPERANDLIST  */
...
yysymbol_name (yysymbol_kind_t yysymbol)
{
  ...
  {
  "end of file", "error", "invalid token", "IDENTIFIER", "WHITESPACE",
  "'('", "')'", "$accept", "OPERAND", "OPERANDLIST", "OPERATOR", "RESULT", YY_NULLPTR
  };
